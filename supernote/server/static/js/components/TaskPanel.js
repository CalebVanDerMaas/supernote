                ...
                <div class="border-t border-slate-100 pt-4">
                    ...
                    <nav class="space-y-1">
                        <div v-for="group in taskGroups" :key="group.id" class="group flex items-center justify-between">
                            ...
                            <button @click.stop="removeGroup(group.id)" class="opacity-0 group-hover:opacity-100 text-slate-400 hover:text-rose-600 p-1.5 transition-opacity" title="Delete Group">
